<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="edit" %>
                ...
                <div class="box-content card white">
                    ...
                    <div class="card-content">
                        ...
                        <asp:TextBox ID="contactno" runat="server" placeholder="Enter Contact Number" class="form-control"></asp:TextBox>
                            ...
                            <asp:Button ID="submit" Text="Update Contact" runat="server" class="btn btn-success btn-sm waves-effect waves-light" OnClick="submit_Click"  />
